    ...
    <main>
      ...
      <section className="video-section">
        ...
        <div style={{ padding: "56.25% 0 0 0", position: "relative" }}>
          <iframe src="https://player.vimeo.com/video/1223442001?title=0&byline=0&portrait=0&badge=0&autopause=0&player_id=0&app_id=58479&controls=1&progress_bar=1&share=0&watch_later=0&vimeo_logo=0&dnt=1" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share" referrerPolicy="strict-origin-when-cross-origin" title="UPDATED LANDING PAGE BOOTCAMP VIDEO 2" style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", border: 'none' }}></iframe>
        </div>
